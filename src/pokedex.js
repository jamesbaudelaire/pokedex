export const Pokedex = [
  ...
  },
  {
    habitat: "grassland",
    info:
      "Bites anything\nwhen it attacks.\nSmall and very\fquick, it is a\ncommon sight in\nmany places. It also comes out onto open fields to steal food from stupid travelers",
    name: "Rattata",
    id: 19,
    speed: 72,
    "special-defense": 35,
  ...
  {
    habitat: "rough-terrain",
    info: `It shoots itself suddenly high into the sky, then plummets down in one fell swoop to strike its prey.
    `,
    name: "Fearow",
    id: 22,
    speed: 100,
  ...
  },
  {
    habitat: "waters-edge",
    info:
      " a pathetic excuse for a Pokémon that is only capable of flopping and splashing",
    name: "Magikarp",
    id: 129,
    speed: 80,
    "special-defense": 20,
  ...
  },
  {
    habitat: "rare",
    info:
      "One of the legendary bird Pokémon. It is said that\nits appearance indicates the coming of spring.",
    name: "Moltres",
    id: 146,
    speed: 90,
    "special-defense": 85,
